...
public class UserSearchRequestResult {
    private String human_id;
    private String human_name;
    private String human_etcinfo;
    private String human_age;
    private String human_job;
    private String human_tel;
    private String human_imageurl;
    private String human_emailaddress;
    private String human_introduction;
    private String human_department;
    ...
    public String getHuman_emailaddress() {
        return this.human_emailaddress;
    }
    ...
    public String getHuman_introduction() {
        return this.human_introduction;
    }
