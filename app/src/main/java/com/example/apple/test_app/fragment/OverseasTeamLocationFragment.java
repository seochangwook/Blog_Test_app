 ...
 */
public class OverseasTeamLocationFragment extends Fragment {
    String search_value = ""; //기본 빈 문자열//

    public OverseasTeamLocationFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_overseas_team_location, container, false);
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        searchview.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                Toast.makeText(getActivity(), "위치 검색어: " + search_value, Toast.LENGTH_SHORT).show();
